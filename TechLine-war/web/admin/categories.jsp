                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <c:forEach items="${lsCategoryEnabble}" var="cat">
                                                    <tr>
                            ...
                            <div class="col-md-12">
                                <div class="card card-plain">
                                    <div class="card-header" data-background-color="purple">
                                        <h4 class="title">Categories is disable</h4>
                                        <p class="category">Line Tech</p>
                                    </div>
                                    <div class="card-content table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                <c:forEach items="${lsCategoryDisable}" var="cat">
                                                    <tr>
                                                        <td><input type="checkbox" value="" name="cbkCusID"/></td>
                                                        <td>${cat.categoryId}</td>
                                                        <td>${cat.categoryName}</td>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <c:forEach items="${lsBrandEnable}" var="cat">
                                                    <tr>
                                                        <td><input type="checkbox" value="" name="cbkCusID"/></td>
                                                        <td>${cat.brandId}</td>
                                                        <td>${cat.brandName}</td>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header" data-background-color="purple">
                                        <h4 class="title">Brand is disable</h4>
                                        <p class="category">Line Tech</p>
                                    </div>
                                    <div class="card-content table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <c:forEach items="${lsBrandDisable}" var="cat">
                                                    <tr>
                                                        <td><input type="checkbox" value="" name="cbkCusID"/></td>
                                                        <td>${cat.brandId}</td>
                                                        <td>${cat.brandName}</td>
