                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" class="form-control" name="txtTypeName" value="${type.typeName}" pattern="[A-Za-z0-9]{1,50}" required title="Name contains 1 to 50 characters, no special characters">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
