                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <textarea rows="10" cols="80" class="form-control" name="txtSummary">${productDetail.productSummary}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <textarea rows="10" cols="80" class="form-control" name="txtDescription">${productDetail.productDesc}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="number" class="form-control" name="txtPrice" value="${productDetail.productPrice}">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group label-floating">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="number" class="form-control" name="txtDiscount" value="${productDetail.productDiscount}">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group label-floating">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="number" class="form-control" name="txtQuantity" value="${productDetail.productQuantity}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" class="form-control" name="txtWeight" value="${productDetail.productWeight}">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Width</label>
                                                    <input type="text" class="form-control" name="txtWidth" value="${productDetail.productWidth}"> 
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Height</label>
                                                    <input type="text" class="form-control" name="txtHeight" value="${productDetail.productHeigth}">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group label-floating">
                                                    <label class="control-label">Length</label>
                                                    <input type="text" class="form-control" name="txtLength" value="${productDetail.productLength}">
                                                </div>
                                            </div>
                                        </div>
                                        <button type="submit" class="btn btn-primary" name="action" value="sellerEditProduct">Save</button>
